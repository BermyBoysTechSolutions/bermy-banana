...
export default function ModeAPage() {
  ...
  // Fetch avatars and products on mount
  useEffect(() => {
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">2. Product (Optional)</CardTitle>
              <CardDescription>Feature a product in your video</CardDescription>
            </CardHeader>
            <CardContent>
              {loadingProducts ? (
                <div className="flex justify-center py-8">
